    ...
    <header class="absolute inset-x-0 top-0 z-50">
        <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                ...
                <a href="/tasks" class="text-sm/6 font-semibold text-gray-900">Tasks</a>
            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end space-x-4">
                ...
                <a href="#" class="text-sm/6 font-semibold text-gray-900">Register <span
                        aria-hidden="true">&rarr;</span></a>
            </div>
        </nav>
                ...
                <div class="mt-6 flow-root">
                    <div class="-my-6 divide-y divide-gray-500/10">
                        <div class="space-y-2 py-6">
                            ...
                            <a href="/tasks"
                                class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Tasks</a>
                            <a href="/about"
